...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-white border-b border-[#DDDDDD]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-16">
          {/* Logo and Main Nav */}
          <div className="flex items-center">
            <Link href="/home" className="text-xl font-bold text-[#C1272D] mr-8">
              Dojo
            </Link>
            ...
            <div className="md:hidden">
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-48">
                  ...
                  <DropdownMenuItem>
                    <Link href="/gyms" className="w-full">Gyms</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
                    <Link href="/sparring" className="w-full">Sparring</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem>
