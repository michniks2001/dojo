...
urlpatterns = [
    ...
    path('posts/<slug:slug>/',
         views.PostRetrieveUpdateDestroyView.as_view(), name='post-detail'),
    ...
    path('posts/<int:post_id>/like/',
         views.LikeCreateView.as_view(), name='post-like'),
    path('posts/<int:post_id>/unlike/',
         views.LikeDestroyView.as_view(), name='post-unlike'),

    path('poses/<int:post_id>/comment/',
         views.CommentListCreateView.as_view(), name='comment-list-create'),
    path('poses/<int:post_id>/comment/<int:pk>/',
         views.CommentRetrieveUpdateDestroyView.as_view(), name='comment-detail'),
]
